...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/d3/dist/d3.js":[function(require,module,exports) {
var define;
...
(function (global, factory) {
  ...
  function stratify() {
    ...
    function stratify(data) {
      ...
      if (path != null) {
        ...
        var _iterator59 = _createForOfIteratorHelper(P),
            _step61;

        try {
          for (_iterator59.s(); !(_step61 = _iterator59.n()).done;) {
            var _i19 = _step61.value;

            if (!S.has(_i19)) {
              S.add(_i19);
              I.push(_i19);
              P.push(parentof(_i19));
              nodes.push(imputed);
            }
          }
        } catch (err) {
      ...
      if (path != null) {
        ...
        for (var _i20 = nodes.length - 1; _i20 >= 0; --_i20) {
          node = nodes[_i20];
  ...
  function normalize$1(path) {
    ...
    if (path[i] === "/") {
      ...
      if ((_k3 & 1) === 0) path = path.slice(0, -1);
    }
  ...
  function sequentialQuantile() {
    ...
    scale.domain = function (_) {
      ...
      var _iterator62 = _createForOfIteratorHelper(_),
          _step64;
  ...
  function stack() {
    ...
    function stack(data) {
      ...
      var _iterator63 = _createForOfIteratorHelper(data),
          _step65;

      try {
        for (_iterator63.s(); !(_step65 = _iterator63.n()).done;) {
          var d = _step65.value;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","node_modules/d3/dist/d3.js"], null)
//# sourceMappingURL=/d3.abbbd36b.js.map